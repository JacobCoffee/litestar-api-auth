...
project = "litestar-api-auth"
copyright = f"{datetime.now(tz=UTC).year}, Jacob Coffee"  # noqa: A001
author = "Jacob Coffee"

# Get version dynamically
try:
    from litestar_api_auth import __version__
...
html_theme_options = {
    "accent_color": "teal",
    "github_url": "https://github.com/JacobCoffee/litestar-api-auth",
    "nav_links": [
        {"title": "Litestar", "url": "https://litestar.dev/"},
        {"title": "PyPI", "url": "https://pypi.org/project/litestar-api-auth/"},
    ],
}
